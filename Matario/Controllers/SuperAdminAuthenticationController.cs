...
namespace Matario.Controllers
{
    ...
    [ApiController]
	[Route($"{ApiConstant.RouteConstants.SuperAdminBaseRoute}/[controller]")]
	public class SuperAdminAuthenticationController : BaseApiController
    {
		private readonly IMediator _mediator;
		public SuperAdminAuthenticationController(IMediator mediator)
		{
			_mediator = mediator;
		}
