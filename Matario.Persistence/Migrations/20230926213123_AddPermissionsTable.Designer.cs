...
namespace Matario.Persistence.Migrations
{
    ...
    [Migration("20230926213123_AddPermissionsTable")]
            ...
            modelBuilder.Entity("Matario.Domain.Entities.AuthenticationModule.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 9, 26, 21, 31, 23, 93, DateTimeKind.Utc).AddTicks(8320),
                            Description = "Allows users with permission to create Managers",
                            Name = "Create Manager",
                            RecordStatus = 1,
                            UpdatedAt = new DateTime(2023, 9, 26, 21, 31, 23, 93, DateTimeKind.Utc).AddTicks(8330)
                        });
                });
            ...
            modelBuilder.Entity("Matario.Domain.Entities.AuthenticationModule.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2023, 9, 26, 21, 31, 23, 104, DateTimeKind.Utc).AddTicks(6400),
                            CreatedBy = 0L,
                            Description = "Super Admin Priviledges",
                            Name = "SuperAdmin",
                            RecordStatus = 1,
                            UpdatedAt = new DateTime(2023, 9, 26, 21, 31, 23, 104, DateTimeKind.Utc).AddTicks(6400)
                        });
                });
